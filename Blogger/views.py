...
def posts(request):
    ...
    return render(request, 'Blogger/posts.html', context)
...
def deletePost(request, slug):
    ...
    if request.method == 'POST':
        ...
        return redirect('posts')
    context = {'item':post}
    return render(request, 'Blogger/delete.html', context)
...
def sendEmail(request):
    ...
    if request.method == 'POST':
        ...
        template = render_to_string('Blogger/email_template.html', {
    ...
    return render(request, 'Blogger/email_sent.html')
...
def userAccount(request):
    ...
    return render(request, 'Blogger/account.html', context)
...
def updateProfile(request):
    ...
    context = {'form':form}
    return render(request, 'Blogger/profile_form.html', context)